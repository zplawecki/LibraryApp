...
use MyBundle\Entity\Book;
use MyBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MyBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("MyBundle:Book:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MyBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MyBundle:Book:edit.html.twig")
     */
