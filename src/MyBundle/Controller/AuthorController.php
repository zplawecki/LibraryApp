...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MyBundle:Author')->findAll();
     ...
     * @Method("POST")
     * @Template("MyBundle:Author:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MyBundle:Author')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MyBundle:Author:edit.html.twig")
     */
